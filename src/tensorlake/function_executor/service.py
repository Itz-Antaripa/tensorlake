...
from .events import (
    ...
    log_event_initialization_finished,
    log_event_initialization_started,
)
...
class Service(FunctionExecutorServicer):
    ...
    def initialize(
        ...
        log_event_initialization_started(event_details)
        ...
        try:
            ...
            log_event_initialization_finished(event_details, success=False)
            ...
            return InitializeResponse(
                ...
                diagnostics=InitializeDiagnostics(
                    log=self._logger.read_till_the_end(start=0),
                ),
            )
        ...
        log_event_initialization_finished(event_details, success=True)
        return InitializeResponse(
